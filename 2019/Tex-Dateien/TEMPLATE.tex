...
\newcommand{\anwesende}{\vorsitz\ (Vorsitz), Christoph Heinen, Max Dietrich}
...
\begin{itemize}[label=$\Box$]
\sym{0} Wahl des Wahlleiters und des  Wahlausschusses
\sym{0} Festlegung des Wahltermins
\sym{0} Wahlausschusssitzungen
\sym{0} Protokoll der Wahlvollversammlung
...
\sym{0} Liste der an der Auszählung beteiligten Wahlhelferinnen und Wahlhelfer
