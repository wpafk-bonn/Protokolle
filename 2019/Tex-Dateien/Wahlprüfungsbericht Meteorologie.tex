...
\newcommand{\gremium}{FSR} % Bei der Wahl gewähltes Gremium.
\newcommand{\wahltermin}{01. -- 03. Juli 2019}
\newcommand{\sitzungstermin}{19. Februar 2020}
\newcommand{\vorsitz}{Christoph Liedel}
\newcommand{\anwesende}{\vorsitz\ (Vorsitz), Christoph Heinen, Max Dietrich, Melanie Schäffler, Thi Phuong Ha Nguyen}
\newcommand{\berichterstatter}{- nicht anwesend -} % Bevollmächtigte Vertretung der geprüften Fachschaft.
%==========================================================================
...
Laut Protokoll des Wahlausschusses wurde das Wählendenverzeichnis nicht ausgelegt.
...
\begin{itemize}[label=$\Box$]
	\sym{2} Das Wahlverfahren steht im Einklang mit der Fachschaftssatzung
...
\end{itemize}
Zum Wahltermin hatte die Fachschaft keine in der AKUT veröffentlichte Satzung, es gilt daher das reguläre Wahlverfahren im Sinne der FSWO.
Dem WPAF ist nicht bekannt, ob die Möglichkeit eines Antrags gemäß § 26 Abs. 2
FSWO bekannt gemacht wurde, entsprechende Anträge lagen nicht vor.
