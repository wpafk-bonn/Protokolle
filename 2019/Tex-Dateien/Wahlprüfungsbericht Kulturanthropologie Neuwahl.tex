...
\sym{3} Festlegung des Wahltermins
...
\sym{2} Mitgliederliste von FSV und FSR zum Zeitpunkt der Wahl des Wahlausschusses
...
Der Wahltermin wurde vom Wahlausschuss statt von der FSV festgelegt.
 ...
 Die FSR- und FSV-Zusammensetzung wurde teilweise zugesandt, die Angehörigen der FSV fehlen.%konnte jedoch alternativ ermittelt werden. 

Kandidierende waren Teil des Wahlausschusses.
...
\begin{itemize}[label=$\Box$]
\sym{0} Festlegung Wahltermin 30 Tage vor Wahl
\sym{0} Wahl Wahlleiter und Wahlausschuss 30 Tage vor Wahl
\sym{0} Konstituierende Wahlausschusssitzung 25 Tage vor Wahl
\sym{0} Festlegung Termine, Fristen und Orte 25 Tage vor Wahl
\sym{0} Übernahme Wählendenverzeichnis 19 Tage vor Wahl
\sym{0} Wahlbekanntmachung 18 Tage vor Wahl
\sym{0} Auslage Wählendenverzeichnis an mindestens 3 Werktagen vor Frist
\sym{0} Frist für Kandidaturen und Anträge 13 Tage vor Wahl bis 10 Tage vor Wahl
\sym{0} Konstituierende FSV-Sitzung 5 bis 14 Tage nach Wahl, oder im Fall einer Wahl-Vollversammlung sofort
\end{itemize}
...
\begin{itemize}[label=$\Box$]
	\sym{0} Die Wahl des Wahlausschusses durch FSV oder FSR wurde in der Sitzungseinladung mit einem Verweis auf § 26 Abs. 2 FSWO angekündigt
...
\begin{itemize}[label=$\Box$]
\sym{0} Kandidierende sind wahlberechtigt und wählbar
\sym{0} Kandidaturen sind ordnungsgemäß
\end{itemize}
...
Die nicht markierten Punkte wurden aufgrund der Fehlerhaften Besetzung des Wahlausschusses nicht geprüft.
