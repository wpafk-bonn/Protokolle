...
\sym{3} Liste der an der Auszählung beteiligten Wahlhelferinnen und Wahlhelfer
...
\sym{4} Briefwahlanträge (Originale)
\end{itemize}
...
\begin{itemize}[label=$\Box$]
\sym{3} Festlegung Wahltermin 30 Tage vor Wahl
