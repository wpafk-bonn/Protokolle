...
\newcommand{\wahltermin}{24. -- 26. 11. 2020}
\newcommand{\sitzungstermin}{16. 11. 2021}
\newcommand{\vorsitz}{Fiona Oberem}
\newcommand{\anwesende}{\vorsitz\ (Vorsitz), Christoph Heinen, Mara Weber, Henrike Antony}
...
\sym{1} Protokolle und Sitzungseinladungen: (Kopien)
...
Das Wählendenverzeichnis wurde einen Tag zu spät Übernommen, die fristgerechte Auslage wurde dadurch aber nicht gefährdet.
...
ODER
\begin{itemize}[label=$\Box$]	
	\sym{1} Anträge zum Wahlverfahren wurden ordnungsgemäß behandelt
\end{itemize}

\section{Kandidaturen}
\begin{itemize}[label=$\Box$]
\sym{1} Kandidierende sind wahlberechtigt und wählbar
\sym{2} Kandidaturen sind ordnungsgemäß
\end{itemize}
...
Eine Kandidatur war auch über eine Liste im Fachschaftsbüro der Geographie möglich. Auf dieser Liste fehlt die Angabe des zu wählenden Gremiums. Die weiteren Kandidaturen waren korrekt.
...
Auf dem Stimmzettel sind leicht unterschiedliche Streifen aufgrund eines Druckerproblems erkennbar, außerdem sind die Stimmzettel nicht genau mittig geschnitten. Dadurch sind die Stimmzettel, mit einigem Aufwand, unterscheidbar.
...
\sym{2} Wahlergebnis wurde korrekt festgestellt 
\end{itemize}

In der Wahlbekanntmachung wird teilweise fälschlicherweise der Begriff "Wahlvorschlag" anstatt "Kandidatur" gebraucht.

Beim Wahlergebnis wird von "Stellvertreter:innen" gesprochen. Laut FSWO sind nicht Gewählte keine Stellvertreter:innen sondern rücken nach, wenn ein Mitglied zurücktritt bzw. ausscheidet.
...
Das Wahlergebnis enthält falsche Formulierungen.
